...
DEFAULT_CONFIG = {
    ...
    'image_generation.openai.key_source': os.getenv('IMAGES_OPENAI_KEY_SOURCE', 'literal'),
    'image_generation.openai.compatibility': os.getenv('IMAGES_OPENAI_COMPATIBILITY', 'standard'),
    ...
    'images.edit.openai.key_source': os.getenv('IMAGES_EDIT_OPENAI_KEY_SOURCE', 'literal'),
    'images.edit.openai.compatibility': os.getenv('IMAGES_EDIT_OPENAI_COMPATIBILITY', 'standard'),
